...
namespace aleia\LaravelMenu\Models;

use aleia\LaravelMenu\Exceptions\MachineNameInvalidArgument;
use aleia\LaravelMenu\Exceptions\MenuAlreadyExists;
use aleia\LaravelMenu\Exceptions\MenuNotExists;
